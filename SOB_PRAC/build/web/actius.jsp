        ...
        <tbody>
            <%
                ...
                for(Projecte projecte : list){
                    ...
                    out.print("</td><td>"+projecte.getEstat()+"</td><td>"+projecte.getEstudis()+"</td><td>"+projecte.getDescripcio()+"</td><td>"+projecte.getEstudiants()+"</td><td>"+projecte.getRecursos()+"</td><td>"+projecte.getData_defensa()+"</td><td>"+projecte.getData_modificacio()+"</td><td>"+projecte.getData_creacio()+"</td><tr>");
                }
            %>
        </tbody>
    </table>
