            ...
            <tr>
                ...
                <td>
                    <%if(p==null){
                      ...
                      out.print("<input name=nombre type=text value='"+p.getData_defensa()+"' size=100 maxlength=100>");
                  }%> 
            </tr>
            <tr>
                <td> Qualificació </td>
                <td>
                    <%if(p==null){
                      ...
                      out.print("<input name=nombre type=text value='"+p.getQualificacio()+"' size=100 maxlength=100>");
                  }%> 
            </tr>
            <tr >
